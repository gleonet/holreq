class LeavesController < ApplicationController
  ...
  def new
    ...
    @leave.user = @user
    @leave.year = Time::now.strftime("%Y")
  end
  ...
  def create
    ...
    respond_to do |format|
      if @leave.save
        format.html { redirect_to @leave.user, notice: 'Leave was successfully created.' }
  ...
  private
    ...
    def leave_params
      params.require(:leave).permit(:user_id, :year, :leave_type_id, :nb_hours)
    end
end
